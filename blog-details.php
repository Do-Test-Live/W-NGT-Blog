                    ...
                    <div class="col-lg-7 blog-details-slider pb-3 text-center d-flex justify-content-center align-items-center">
                        <div class="row pt-md-0 pb-md-0 pt-5 pb-5">
                            <div class="col-md-3 d-md-flex justify-content-center align-items-center d-none">
                                <img alt="" class="img-fluid" src="assets/images/blog/Limg.png"/>
                            </div>
                            <div class="col-md-6 col-12">
                                <img alt="" class="img-fluid" src="assets/images/blog/blog_1.png"/>
                            </div>
                            <div class="col-md-3 d-md-flex justify-content-center align-items-center d-none">
                                <img alt="" class="img-fluid" src="assets/images/blog/rimg.png"/>
                            </div>
                            <div class="col-md-6 col-12 mx-auto pb-md-0 pb-5">
                                <h4 class="mt-4 ngt-demo-title">Lorem Ipsum is simply </h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5 pb-3">
                        <h4 class="ngt-demo-title">Lorem Ipsum is simply dummy text of the</h4>
                        <p class="text-white ngt-blog-content" style="text-align: justify">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                            labore
                            et dolore magna aliqua. Turpis in eu mi bibendum neque egestas congue. Id neque aliquam
                            vestibulum
                            morbi blandit cursus risus at. Egestas tellus rutrum tellus pellentesque. Viverra aliquet
                            eget sit
                            amet tellus cras adipiscing enim. Et malesuada fames ac turpis egestas.
                        </p>
                        <p class="text-white ngt-blog-content" style="text-align: justify">
                            Bibendum arcu vitae elementum curabitur vitae nunc sed velit. Tempor orci dapibus ultrices
                            in
                            iaculis nunc sed. Libero
                            enim sed faucibus turpis. Venenatis a condimentum vitae sapien pellentesque habitant.
                            Adipiscing
                            elit ut aliquam purus. Nulla facilisi etiam dignissim diam quis.
                        </p>
                        <p class="text-white ngt-blog-content" style="text-align: justify">
                            Pulvinar mattis nunc sed blandit libero volutpat sed cras. Sit amet porttitor eget dolor
                            morbi non
                            arcu. Arcu risus quis varius quam quisque id. Enim eu turpis egestas pretium aenean
                            pharetra.
                            Tristique et egestas quis ipsum suspendisse ultrices gravida. Dictum sit amet justo donec.
                            Sed arcu
                            non odio euismod lacinia. At consectetur lorem donec massa sapien faucibus et. Ac felis
                            donec et
                            odio pellentesque. Massa tincidunt nunc pulvinar sapien et ligula ullamcorper.
                        </p>
                        <p class="text-white ngt-blog-content" style="text-align: justify">
                            Tellus rutrum tellus pellentesque eu. Orci dapibus ultrices in iaculis nunc. Pharetra
                            convallis
                            posuere morbi leo urna molestie at elementum.
                        </p>
                        <div class="text-end">
                            <a class="btn btn-primary ngt-blog-btn-back mt-3" href="index.php">
                                Back
                            </a>
                        </div>
                    </div>
